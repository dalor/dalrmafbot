...
class URL:
    def __init__(self, method, data, bot, file=None):
        #self.loop = bot.loop
        self.params = data
...
class Message:
    ...
    def audio(self, audio, chat_id=None, **kwargs):
        return self.bot.audio(audio, self.data['chat']['id'] if not chat_id else chat_id, **kwargs)
...
class Bot:
    ...
    def audio(self, audio, chat_id, **kwargs):
        kwargs['audio'] = audio
        kwargs['chat_id'] = chat_id
